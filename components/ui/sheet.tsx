...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card border-border shadow-2xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-400 flex flex-col",
  {
    variants: {
      side: {
        right:
