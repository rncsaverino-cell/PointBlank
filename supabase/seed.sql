-- PointBlank sample data: 3 active collections + 3 flagship products.
...
--
-- Wild West, Zombie Apocalypse, and Alien Invasion are the only active
-- collections right now; Spy Mission, Classic Series, and Limited Editions
-- are seeded inactive so they're easy to bring back later.
--
