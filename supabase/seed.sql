...
--
-- Wild West, Zombie Apocalypse, Alien Invasion, and Monster Hunt are the
...
insert into collections (id, name, slug, subtitle, description, hero_image, sort_order, active) values
  ...
  (gen_random_uuid(), 'Monster Hunt', 'monster-hunt', 'The wild is watching back.', 'Apex predators lurking in the fog. A moody wilderness collection for hunters and range-goers who want their targets to feel alive.', 'https://placehold.co/1600x900/0d1420/3d8bc4?text=MONSTER+HUNT', 7, true)
...
insert into products (sku, name, slug, description, collection_id, wholesale_price, msrp, moq, pack_quantity, dimensions, paper_spec, inventory, image_url, gallery, is_new, is_bestseller, is_limited, is_range_favorite) values
  ...
  ('MH-PREDPATH-10T', 'Predator''s Path', 'predators-path', 'A misty forest scene with 10 numbered apex predators and game animals stalking through the fog, from black bears to timber wolves.', (select id from collections where slug = 'monster-hunt'), 26.00, 44.99, 15, 15, '24 x 36 in', '28lb premium target paper, matte finish', 200, '/products/predators-path.png', '[]', true, false, false, false)
